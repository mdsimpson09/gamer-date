...
<div className=' -mt-10 container flex justify-center items-center bg-indigo-300 p-5 md:p-10 rounded-xl w-full max-w-xs md:max-w-lg h-auto mb-0 max-h-[750px] md:max-h-[700px]'>
