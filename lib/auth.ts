  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials: Record<"email" | "password", string>, req){
        ...
        // Assuming id, username, and email are the only required properties
        // Adjust this to match your actual User type
        return {
          id: existingPlayer.player_id.toString(), // Ensure this matches the type expected by your User interface
          username: existingPlayer.username,
          email: existingPlayer.email,
          // Include other properties as required by your User type, marking optional ones as needed
        };
      }
    })
  ],
